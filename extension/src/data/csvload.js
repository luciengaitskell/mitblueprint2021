...
export const fullData = (callback) => {
  var universities = {}; //empty object - value corresponding cell of year

  d3.csv(
    'https://raw.githubusercontent.com/WilliamKopans/UniVisData/main/CollegeData.csv',
    function (data) {
      let univData = {};
      ...
      univData['percaid'] =
        data[
          'Percent.of.undergraduate.students.awarded.federal..state..local..institutional.or.other.sources.of.grant.aid..SFA1819.'
        ];
